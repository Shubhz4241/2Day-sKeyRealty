...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT id, title, short_content, full_article, image, source, article_name, date FROM news WHERE id = $newsId";
...
<body>
    ...
    <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
        <div class="container">
            ...
            <a href="index.php">
                <img src="img/logo1.jpg" alt="2DAY'SKEY REALTY Logo"
            ...
            <div class="row">
                <div class="col-md-12 col-lg-8">
                    <div class="title-single-box">
                        <h1 class="title-single"><?php echo htmlspecialchars($news['title']); ?></h1>
                        <span class="color-text-a"><?php echo htmlspecialchars($news['source']); ?></span>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="news-img-box">
                        <!-- Dynamically load image from database -->
                        <img src="admin/news/<?php echo $news['image']; ?>" alt="News Image" class="img-fluid">
                    </div>
                </div>
                <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                    <div class="post-information">
                        <ul class="list-inline text-center color-a">
                            ...
                            <li class="list-inline-item">
                                <strong>Date: </strong>
                                <span class="color-text-a"><?php echo date('d M Y', strtotime($news['date'])); ?></span>
                                <!-- Dynamic Date -->
                            </li>
                        </ul>
                    </div>
                    <div class="post-content color-text-a">
                        <p class="post-intro">
                            <?php echo $news['short_content']; ?> <!-- Dynamic Short Content -->
                        </p>
                        <p>
                        ...
                        <blockquote class="blockquote">
                            <p class="mb-4"><?php echo $news['full_article']; ?></p>
                            <footer class="blockquote-footer">

                                <strong>Source: </strong>
                                <cite class="color-text-a"><?php echo $news['source']; ?></cite> <!-- Dynamic Author -->
                    ...
                    <div class="widget-a">
                        ...
                        <div class="w-body-a">
                            <p class="w-text-a color-text-a">
                                Shop No.8,Shelter Complex, Plot No.12-B,Sector-8,Kharghar, Navi Mumbai, Maharashtra
                                410210
                            </p>
                        </div>
